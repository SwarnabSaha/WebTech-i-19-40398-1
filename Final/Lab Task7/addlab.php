...
if (empty($_SESSION['username'])) {
 ...
 ?>
    <hr>
    <form action="controller/create.php" method="post" style="border: 5px;margin-top: 10px;margin-bottom: 0px; margin-left: 300px;margin-right: 300px;border-style: solid;border-color: black;padding: 1em;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
